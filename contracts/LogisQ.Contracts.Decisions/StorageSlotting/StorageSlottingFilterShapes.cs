...
/// <summary>
/// Context filter shape descriptors for Storage.Slotting.
/// WMS computes specificity from these shapes — specificity is never hardcoded.
/// </summary>
public static class StorageSlottingFilterShapes
{
    ...
    /// <summary>Shape: shape:plantArea+zone (priority 2)</summary>
    public static readonly ContextFilterShape PlantAreaZone =
        new("shape:plantArea+zone", new[] { "plantArea", "zone" }, PriorityClass: 2);
}
